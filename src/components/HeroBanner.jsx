    ...
    <section className="relative w-full h-[70vh] max-h-[720px] overflow-hidden">
      ...
      <div className="absolute left-[5%] bottom-[10%] max-w-xl space-y-4">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handlePlay}
            className="flex items-center justify-center h-11 px-6 rounded-md bg-white text-black text-lg font-semibold"
          >
            ▶ 재생
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center h-11 px-6 rounded-md bg-neutral-700/80 text-white text-lg font-semibold"
          >
            ⓘ 상세 정보
          </button>
        </div>
